        ...
        <Fragment>
            <Container sx={{py:12,width:"90%"}}>
                <Grid container spacing={4} >
                    ...
                    <Voicecard
                    voicecardheading = "Quotes, Invoices, Payments"
                    voicecardcontent="The application provides CRM-like management for your clients. Enter contact details, notes or add custom fields. Basic project and task management is also available."
                     ...
                     <Voicecard
                     voicecardheading = "Manage your Clients"
                    ...
                    <Voicecard
                    voicecardheading = "Customize InvoicePlane"
                     ...
                     <Voicecard
                     voicecardheading = "One-Click Online Payments"
                     ...
                     <Voicecard
                     voicecardheading = "Multilanguage Interface"
